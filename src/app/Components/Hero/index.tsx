...
const Hero = ({bgImage, title, text}:HeroProps) => {
  return (
    <div className={`${bgImage ? "bg-officeHero bg-cover bg-no-repeat h-[calc(100vh-5rem)] text-white" : "" }`}>
        ...
        <div className={`flex flex-col text-center ${bgImage ? "mb-28 border-x-4 border-x-white px-4 md:pt-20 pt-24 pb-8 mx-4 md:mx-12 lg:mx-24 gap-10 md:gap-14" : "border-x-4 border-x-blue px-4 md:mt-20 mt-14 pt-8 pb-8 mx-4 md:mx-12 lg:mx-24 gap-10 md:gap-14"}`}>
