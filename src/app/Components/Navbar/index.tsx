...
const Navbar = () => {
  ...
  return (
    <header className='flex z-50 top-0 items-center justify-between px-8 py-4 border-b-blue border-b h-20 w-full bg-white'>
      ...
      <nav>
        <ul id='menu-mobile' className='hidden text-center lg:flex flex-col lg:flex-row items-start lg:items-center justify-start lg:static absolute top-20 left-0 h-screen bg-white lg:bg-transparent gap-20 lg:gap-10 z-50 w-full pl-8 pt-20 pb-20 lg:pt-0 lg:pl-0 lg:pb-0 text-3xl font-black lg:text-base'>
