    ...
    return (
        <div className={`${bgBlue ? "bg-blue text-white" : "bg-white"} ${rowReverse ? "flex-col lg:flex-row-reverse" : "flex-col lg:flex-row"} flex items-center gap-8 lg:gap-20 p-10 lg:p-28`}>
                <div className="w-full flex flex-col gap-8"
                    >
                        <h2 data-aos="fade-up" data-aos-delay="400" className='text-3xl md:text-4xl lg:text-3xl font-black'>{title}</h2>
                        <p data-aos="fade-up" data-aos-delay="400" className='text-lg lg:w-11/12 leading-9'>
                                {text}
                        </p>
                </div>
